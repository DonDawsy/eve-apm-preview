...
{
    return QString("font-size: 13px; color: %1; line-height: 1.5;").arg(colorTextSecondary());
}

QString StyleSheet::getFeatureLabelStyleSheet()
{
    return QString("color: %1; font-size: 12px; padding: 2px 0px;").arg(colorTextSecondary());
}
...
{
    return QString("color: %1; font-size: 13px; margin-left: 24px;").arg(colorTextPrimary());
}

QString StyleSheet::getSubLabelStyleSheet()
{
    return QString("color: %1; font-size: 13px; margin-top: 10px;").arg(colorTextSecondary());
}

QString StyleSheet::getDialogInfoLabelStyleSheet()
{
    return QString("color: %1; font-size: 13px; margin-bottom: 8px;").arg(colorTextSecondary());
}
...
QString StyleSheet::getColorButtonStyleSheet(const QString& backgroundColor, const QString& textColor)
{
    return QString(
        "QPushButton {"
        "   background-color: %1;"
